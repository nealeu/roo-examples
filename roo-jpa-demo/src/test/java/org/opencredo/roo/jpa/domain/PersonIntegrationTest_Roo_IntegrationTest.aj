...
import org.opencredo.roo.jpa.domain.PersonDataOnDemand;
...
privileged aspect PersonIntegrationTest_Roo_IntegrationTest {
    ...
    public void PersonIntegrationTest.testCountPeople() {
        ...
        long count = org.opencredo.roo.jpa.domain.Person.countPeople();
    ...
    public void PersonIntegrationTest.testFindPerson() {
        org.opencredo.roo.jpa.domain.Person obj = dod.getRandomPerson();
        ...
        obj = org.opencredo.roo.jpa.domain.Person.findPerson(id);
    ...
    public void PersonIntegrationTest.testFindAllPeople() {
        ...
        java.util.List<org.opencredo.roo.jpa.domain.Person> result = org.opencredo.roo.jpa.domain.Person.findAllPeople();
    ...
    public void PersonIntegrationTest.testFindPersonEntries() {
        ...
        java.util.List<org.opencredo.roo.jpa.domain.Person> result = org.opencredo.roo.jpa.domain.Person.findPersonEntries(0, (int) count);
    ...
    public void PersonIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyPerson(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        org.opencredo.roo.jpa.domain.Person merged = (org.opencredo.roo.jpa.domain.Person) obj.merge();
        obj.flush();
    ...
    public void PersonIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Person' failed to initialize correctly", dod.getRandomPerson());
        org.opencredo.roo.jpa.domain.Person obj = dod.getNewTransientPerson(Integer.MAX_VALUE);
    ...
    public void PersonIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Person' with identifier '" + id + "'", org.opencredo.roo.jpa.domain.Person.findPerson(id));
    }
